    ...
    <div class="loginBox">
      <div class="logo">
        <img
          ...
          style="width:50px;height:50px;margin-left:160px;position:relative; top:50px"
        />
        <h2 class="loginH2"><strong>租房网</strong></h2>
      </div>
      <div class="loginCon">
  ...
  methods: {
    ...
    shopTip() {
      this.notifyObj = this.$notify({
        title: '提示',
        message:
          '目前有两个登陆角色，管理员和用户，账号分别为：admin、user,密码都为：123456',
        duration: 0,
...
.login {
  height: 100%;
  width: 100%;
  background: url(../../assets/pageBg/房屋1.jpg) no-repeat center center;
